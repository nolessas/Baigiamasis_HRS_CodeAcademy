        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HumanInformation_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HumanInformationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Addresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Addresses_HumanInformation_HumanInformationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_HumanInformationId",
                table: "Addresses",
                column: "HumanInformationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HumanInformation_UserId",
